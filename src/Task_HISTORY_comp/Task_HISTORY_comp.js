...
//------------------------------------
//-------------------------------------------------
import './Task_HISTORY_comp.css';



//import vidSrc from '../media/yt1s.com - Retrowave animation_1080p.mp4';
//import ToDoElement_comp from '../ToDoElementt_comp/ToDoElement_comp';
import TaskUnit_HISTORY_comp from '../TaskUnit_HISTORY_comp/TaskUnit_HISTORY_comp';
...
import { centerData } from '../Data';
 ...
 class Task_HISTORY_comp extends React.Component {
  state = {
 ...
 if (e.key >-1 && e.key <10 ) {
  ...
  SelectTAskType(typeCode)
  {
    if (typeCode == 0) {
      ...
      this.setState({taskType : "Revision"})
      this.props.setTaskType("Revision")
...
export default connect(mapStateToProps , {setUserData,setCurrentWeeks,setTaskType,setTaskWeekId})(Task_HISTORY_comp);